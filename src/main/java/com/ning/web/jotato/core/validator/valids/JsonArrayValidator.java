...
public class JsonArrayValidator extends AbstractValidator implements Validator {
    private static final Logger log = LoggerFactory.getLogger(JsonArrayValidator.class);
