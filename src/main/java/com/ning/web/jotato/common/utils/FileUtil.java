...
import com.ning.web.jotato.base.utils.CharPool;
...
public class FileUtil extends org.springframework.util.FileCopyUtils {
    ...
    public static String getFileExtension(String fullName) {
        if (!StringUtils.hasText(fullName)) return StringPool.EMPTY;
     ...
     */
    public static String readToString(final File file) throws Throwable {
        return readToString(file, CharsetEnum.UTF_8.get());
    }
     ...
     * @return the file contents, never {@code null}
     */
    public static String readToString(final File file, final Charset encoding) throws Throwable {
     ...
     * @return the file contents, never {@code null}
     */
    public static byte[] readToByteArray(final File file) throws Throwable {
        try (InputStream in = Files.newInputStream(file.toPath())) {
     ...
     */
    public static void writeToFile(final File file, final String data) throws Throwable {
        writeToFile(file, data, CharsetEnum.UTF_8.get(), false);
    }
     ...
     */
    public static void writeToFile(final File file, final String data, final boolean append) throws Throwable {
        writeToFile(file, data, CharsetEnum.UTF_8.get(), append);
    }
     ...
     * @param encoding the encoding to use, {@code null} means platform default
     */
    public static void writeToFile(final File file, final String data, final Charset encoding) throws Throwable {
     ...
     *                 end of the file rather than overwriting
     */
    public static void writeToFile(final File file, final String data, final Charset encoding, final boolean append) throws Throwable {
     ...
     * @param file File
     */
    public static void toFile(MultipartFile multipartFile, final File file) throws Throwable {
        try {
     ...
     * @param file File
     */
    public static void toFile(InputStream in, final File file) throws Throwable {
